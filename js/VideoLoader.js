class VideoLoader{
	constructor(url_,contentVideo){
		this.url=url_;
		this.status = "preload";
		this.contentVideoObjects = [];
		//console.log("create " + this.url)

		this.contentVideoObjects.push(contentAudio_);
	...
	load(){
		...
		request.onload = function() {
			// console.log("cccadoijfjksnvfknfakngvmkadsnmadsnfasgmnfkamnfdasm,nfdsm,dsfnm,")
