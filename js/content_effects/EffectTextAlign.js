class AlignTextEffect extends TextEffect{
	...
	apply(){
			...
			this.parentContent.html.fe.style["text-align"]=this.vareables.value;
	...
	createEditorHTML(){
		...
		this.editor.html.effectTitle.innerHTML="Align Effect"
