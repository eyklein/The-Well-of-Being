class TranslateStaticImageEffect extends ImageEffect{
	constructor(JSON_,parentContent_,effectCatagory_){
		...
		this.type="translate-static";
	}
	apply(){

		// console.log(this.parentContent.html.fe.style.transform);
		...
		this.parentContent.html.fe.style.transform="translate("+this.vareables.left+", " + this.vareables.top+")"
		// this.parentContent.html.fe.style.transform="translate(200%, 20%)";
